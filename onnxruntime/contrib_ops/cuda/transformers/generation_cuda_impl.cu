...
// __global__ void BeamSearchScorer_Dump(int batch, BeamHypotheses* beam_hyps_) {
//   cuda::BeamHypotheses& beam_hyp = beam_hyps_[batch];
//   printf("\n BeamHypotheses for batch %d:\n", batch);
...
void LaunchBeamSearchScorer_Process(BeamScorerState& state_cpu,
  ...
  //   BeamSearchScorer_Dump<<<1, 1, 0, stream>>>(static_cast<int>(i), beam_hyps.data());
  // }
